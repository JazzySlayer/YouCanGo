    ...
    <table>
        ...
        <tr>
            <g:sortableColumn property="firstName"
                              title="${message(code: 'member.firstName.label', default: 'First Name')}"/>

            <g:sortableColumn property="lastName"
                              title="${message(code: 'member.lastName.label', default: 'Last Name')}"/>

            <g:sortableColumn property="middleName"
                              title="${message(code: 'member.middleName.label', default: 'Middle Name')}"/>

            <g:sortableColumn property="email" title="${message(code: 'member.email.label', default: 'Email')}"/>

            <g:sortableColumn property="alterEmail"
                              title="${message(code: 'member.alterEmail.label', default: 'Alter Email')}"/>
        ...
        <g:each in="${memberInstanceList}" status="i" var="memberInstance">
            <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                ...
                <td><g:link action="show"
                            id="${memberInstance.id}">${fieldValue(bean: memberInstance, field: "memberId")}</g:link></td>
                ...
                <td>${fieldValue(bean: memberInstance, field: "alterEmail")}</td>
